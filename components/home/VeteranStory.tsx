    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="relative pl-6">
          ...
          <h2 className="font-heading font-bold text-white text-3xl sm:text-4xl mb-4 leading-tight">
            Built on Service.
            <br />
        ...
        <div className="bg-white/5 rounded-2xl aspect-square flex items-center justify-center">
          <span className="font-body text-white/30 text-sm">Owner photo coming soon</span>
        </div>
      </div>
    </section>
  );
