...
export default function CustomOrderBand() {
  return (
    ...
    >
      ...
      <Link
        href="/custom-order"
        className="inline-flex items-center gap-2 bg-patriot-red hover:bg-patriot-red-dark text-white font-body font-bold px-8 py-3 rounded-md transition-colors duration-150 cursor-pointer"
      >
